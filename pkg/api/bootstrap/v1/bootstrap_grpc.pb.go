...
const (
	BootstrapService_Bootstrap_FullMethodName = "/axiom.bootstrap.v1.BootstrapService/Bootstrap"
)
...
var BootstrapService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "axiom.bootstrap.v1.BootstrapService",
